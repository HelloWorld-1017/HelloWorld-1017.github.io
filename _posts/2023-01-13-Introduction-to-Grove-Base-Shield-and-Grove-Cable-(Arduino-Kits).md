...
![image-20230113080428876](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230113080428876.png)
...
![image-20230113081818412](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230113081818412.png)
...
>
> ![image-20230113182420907](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230113182420907.png)
...
![image-20230113191311446](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230113191311446.png)
...
![image-20230113083727961](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230113083727961.png)
...
![image-20230113195123086](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230113195123086.png)
...
![image-20230113195408765](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230113195408765.png)
...
![image-20230113195558430](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230113195558430.png)

与数字端口类似，这些模拟端口的前两个引脚分别是GND，VCC引脚，分别与Cable的pin4和pin3连接。下面的两个引脚分别是An+1和An引脚，分别与Cable的pin2和pin1相连。

![image-20230113083739832](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230113083739832.png)
...
![image-20230113201137392](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230113201137392.png)

该使用RX引脚（从上到下第四个引脚）串行接收数据，使用TX引脚（从上到下第三个引脚，上图中似乎误标注为DX引脚）串行发送数据：

![image-20230113083753079](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230113083753079.png)

## I2C Ports

Grove Base Shiled一共有4个I2C端口：

![image-20230113202028310](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230113202028310.png)

这四个端口所连接的引脚完全一致（因为Arduino本身值具有一个SCL引脚和一个SDA引脚），可以看做是一根I2C总线分出来的四个端口。

I2C端口具有标准布局。引脚1是SCL信号，引脚2是SDA信号，电源和接地与其他端口相同：

![image-20230113083825781](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230113083825781.png)
