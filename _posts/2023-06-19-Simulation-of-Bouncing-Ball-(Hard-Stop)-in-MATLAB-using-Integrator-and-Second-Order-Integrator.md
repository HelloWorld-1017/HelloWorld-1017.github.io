...
<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617234153030.png" alt="image-20230617234153030" style="zoom: 50%;" />
...
<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230616230803223.png" alt="image-20230616230803223" style="zoom:50%;" />
...
![image-20230617231751756](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617231751756.png)

### `reset` port

模块左边与上升沿触发信号标志所相连的**`reset`端口**，该（触发）端口通过`External reset`参数进行显示和设置：

![image-20230617231807602](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617231807602.png)
...
![image-20230617231835572](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617231835572.png)
...
> ```
>
> ![image-20230617232942147](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617232942147.png)
...
> ```
>
> ![image-20230617232310862](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617232310862.png)
...
<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617212940715.png" alt="image-20230617212940715" style="zoom:67%;" />
...
<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230616231037317.png" alt="image-20230616231037317" style="zoom:50%;" />
...
![image-20230617233337919](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617233337919.png)
...
<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230616231101153.png" alt="image-20230616231101153" style="zoom:50%;" />

二阶积分模块的参数设置如下：

<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617221453585.png" alt="image-20230617221453585" style="zoom: 50%;" />
...
<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617221720336.png" alt="image-20230617221720336" style="zoom: 50%;" />
...
<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617222247891.png" alt="image-20230617222247891" style="zoom:50%;" />

之后，设置模型的`Stop time`为`25`，并在求解器设置中将`Zero-crossing options`中的`Algorithm`参数设置为`Nonadaptive`：

<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617222534358.png" alt="image-20230617222534358" style="zoom:50%;" />

最终运行模型，可以得到第二个模型的输出结果：

<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230616231153639.png" alt="image-20230616231153639" style="zoom: 67%;" />

> 在上述的设置下（即将求解器设置中的`Zero-crossing options`的`Algorithm`参数设置为`Nonadaptive`），可以看到速度波形在20.36 s左右仍有有轻微的抖动：
>
> <img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617223047307.png" alt="image-20230617223047307" style="zoom:80%;" />
>
> 而若设置为`Adaptive`，速度波形在20.7 s左右就为零值了：
>
> <img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617223148162.png" alt="image-20230617223148162" style="zoom:80%;" />
>
...
<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20230617223453785.png" alt="image-20230617223453785" style="zoom:50%;" />
