...
![image-20221228120020298](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228120020298.png)

程序框图预览：

![image-20221228115945173](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228115945173.png)
...
![image-20221228121235050](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228121235050.png)

在前面板中创建两个双精度(DBL)的输入控件，并且简单设置一下它们的默认输入值：

![image-20221228122616560](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228122616560.png)
...
![image-20221228132821785](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228132821785.png)

需要注意的是，在这里，`创建特殊矩阵`函数的`matrix type`输入是一个常量，并不在前面板中显示。

可以简单地检查一下结果：

![image-20221228133219919](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228133219919.png)

在前面板中插入一个经典的水平滑动杆，用于表示变量X和Y的相关度$\rho_{XY}$，取值范围为$[-1,1]$：

![image-20221228134212483](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228134212483.png)
...
![image-20221228141416337](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228141416337.png)
...
![image-20221228155245592](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228155245592.png)

创建三个输入控件，分别是X的平均值、Y的平均值以及种子(seed)：

![image-20221228152716928](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228152716928.png)
...
![image-20221228162521348](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228162521348.png)

## Correlation coefficient and MSE

Spearman相关系数、$R^2$相关系数、Kendall相关系数、均方差的这些值的计算都依赖于X值和Y值：

![image-20221228163102904](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228163102904.png)
...
![image-20221228163424100](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228163424100.png)
...
![image-20221228144345720](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228144345720.png)

之后，将采样点输入到`正弦与余弦`函数中，并将赋值扩大3倍，观察一下结果：

![image-20221228145217547](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228145217547.png)

将结果与协方差矩阵分解后的矩阵相乘，并与X与Y的平均值相加。将X与Y的值捆绑在一起，之后绘制出边界线。

![image-20221228164832522](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228164832522.png)

之后，将上面的X与Y的散点绘制在同一张图中：

![image-20221228165302321](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228165302321.png)

## X and Y plot with respect to t

X和Y的趋势图就是X和Y随t（sample number）变化的曲线：

![image-20221228170313409](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228170313409.png)
...
![image-20221228172154853](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20221228172154853.png)
