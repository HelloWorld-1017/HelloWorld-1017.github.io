---
layout: single
title: Constructing A Simple Logistic Regression Model for Binary Classification Problem with PyTorch
...
在博客[Constructing A Simple Linear Model with PyTorch](http://whatastarrynight.com/machine learning/python/Constructing-A-Simple-Linear-Model-with-PyTorch/)中，我们使用了PyTorch框架训练了一个很简单的线性模型，用于解决下面的数据拟合问题：
...
而对于分类问题，模型的输出是一个概率值，此时的损失函数应当是衡量模型预测的**分布**与真实分布之间的差异，需要使用KL散度，而在实际中更常使用的是交叉熵（参考博客：[Entropy, Cross entropy, KL Divergence and Their Relation](http://whatastarrynight.com/mathematics/machine learning/signals and systems/uncertainty/matlab/Entropy-Cross-Entropy-KL-Divergence-and-their-Relation/)）。对于二分类问题，其损失函数（Binary Cross Entropy loss，BCE losss）为：
...
[1] [06.逻辑斯蒂回归 - 刘二大人](https://www.bilibili.com/video/BV1Y7411d7Ys?p=6&vd_source=8aeddead7f39b0189fff9b14fa090a75).
