...
<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20221201232609322.png" alt="image-20221201232609322"  />

可以看到，这种方法的关键就是`bar`函数和`errorbar`函数的横坐标对齐。但是，当`bar`函数是多分类的情况怎么对齐呢？比如说，实现下面这样的图：

![image-20221201232814238](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20221201232814238.png)
...
![image-20221202001308659](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20221202001308659.png)
...
![image-20221202113915392](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20221202113915392.png)
