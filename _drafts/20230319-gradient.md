...
令$\boldsymbol{\mathrm{A}}$是一个向量场，则Sokes' theorem表明，曲线$C$关于$\boldsymbol{\mathrm{A}}$的线积分与开曲面$S$上的面积分有关：
...
如果$p$表示一个标量场，则类似于Divergence theorem，有Gradient theorem：
