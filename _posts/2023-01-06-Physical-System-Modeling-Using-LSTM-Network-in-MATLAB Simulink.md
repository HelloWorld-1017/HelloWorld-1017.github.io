...
- Simulink的模型有四个输出信号：
  ...
  前三个states用于训练LSTM-ROM，第四个state用于评价训练整个模型的准确度。
...
最后，我们使用held-out test data测试模型。需要注意的是，我们在这里测试的是full model，而非just the LSTM network。**用于测试对比的信号是motor shaft的F signals**。
...
```
注：运行包含LSTM的Simulink模型遇到了各种各样的warnings和errors，调试的具体过程放在文末的Appendix A中。
{: .notice--warning}
...
![image-20230106224031050](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230106224031050.png)
...
![image-20230106230131248](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230106230131248.png)
...
![](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230106231702937.png)
...
![image-20230106234629987](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230106234629987.png)
...
报错的原因是电脑所使用的编译器不在supported GPU MEX的名单中。MATLAB Answers中一则Q&A提到了类似的问题：[Why am I getting this error?](https://ww2.mathworks.cn/matlabcentral/answers/422014-why-am-i-getting-this-error#answer_339593)，Roberson的建议是需要将Visual Sutio作为GPU coder的编译器。于是我就下载了2022版本的Microsoft Visual Studio。再次运行时，则出现了另一个报错：
...
![image-20230102202156779](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230102202156779.png)

再次运行后，软件又报了另外一个错误：

![image-20230102200240610](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230102200240610.png)
...
![image-20230102200556651](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230102200556651.png)

但是也可以看到，再次运行后也仅仅是解决了上述的warning，相同的error仍然存在：

![image-20230102203521976](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230102203521976.png)
...
![image-20230102205106148](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230102205106148.png)

一块独立显卡(NVIDIA Geforce GTX 1050)：

![image-20230102205231088](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230102205231088.png)
...
所以，升级驱动可能会解决这一问题（参考 [2]）。

在桌面右键点击`NVIDIA 控制面板`，再点击软件左下角的系统信息，可以看到GPU的详细信息：

![image-20230102211122461](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230102211122461.png)

可以看到GPU型号是GeForce GTX 1050，此时的驱动程序版本是：398.36。

我们到NVIDIA官网([官方驱动 | NVIDIA](https://www.nvidia.cn/Download/index.aspx?lang=cn))，选择合适的驱动程序并下载：

![image-20230102211754675](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230102211754675.png)

![image-20230102211852305](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230102211852305.png)

此时，电脑重启后打开NVIDIA控制面板，可以看到驱动已经升级成功：

![image-20230102214011372](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/DeLLLaptop/image-20230102214011372.png)
...
[2] [matlab报错：graphics driver version 9.1 is not supported. update graphics driver to version 11or greate_耳东哇的博客-CSDN博客](https://blog.csdn.net/weixin_43930851/article/details/123296435)
