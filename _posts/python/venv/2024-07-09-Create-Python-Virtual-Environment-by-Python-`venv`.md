...
last_modified_at: 2024-10-05 20:42:41 +0800
---
...
[^2]: [Python Guide To Activate Venv / Virtual Environments](https://ioflood.com/blog/python-activate-venv/).
[^3]: [使用当前文件夹下的python pip](https://blog.51cto.com/u_16175427/8206004).
[^4]: [Create and Change Python Environment in Spyder Software](https://helloworld-1017.github.io/2023-04-02/16-42-49.html).
