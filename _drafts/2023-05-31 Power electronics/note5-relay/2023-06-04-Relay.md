...
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Relay_animation_without_flyback_diode_.gif/1200px-Relay_animation_without_flyback_diode_.gif" alt="Relay animation without flyback diode .gif">

（2）配有续流二极管

<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Relay_animation_with_flyback_diode.gif/1200px-Relay_animation_with_flyback_diode.gif" alt="Relay animation with flyback diode.gif">
...
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Relay_symbols.svg/1200px-Relay_symbols.svg.png" alt="Relay symbols.svg" style="zoom: 25%;" >
...
The National Association of Relay Manufacturers及其继任的组织the Relay and Switch Industry Association定义了23中不同的继电器和开关的电气接点形式，其中最常用的以下几种：
...
- SPDT（Single-Pole Double-Throw）继电器：这种继电器具有一个Form C接点。

  注：Form C接点（Form C contacts, AKA 
...
[Electrical contact - Wikipedia](https://en.wikipedia.org/wiki/Electrical_contact)