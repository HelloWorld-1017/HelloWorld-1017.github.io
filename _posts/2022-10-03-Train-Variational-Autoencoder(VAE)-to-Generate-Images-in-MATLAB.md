...
MATLAB提供了一个变分自编码器(Variational Autoencoder, VAE)的示例：[Train Variational Autoencoder (VAE) to Generate Images - MathWorks](https://ww2.mathworks.cn/help/deeplearning/ug/train-a-variational-autoencoder-vae-to-generate-images.html)，该示例展示了一个使用VAE生成图片的过程。

VAE能够生成和原始数据集相同分布的数据。自编码器(autoencoder)是一种通过将输入转换为低维空间（编码步骤）并从低维表示重建输入（解码步骤）来复制其输入的模型。下图展示了autoencoder用于重构数字图像的基本结构：

<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20221003135744682.png" alt="image-20221003135744682" style="zoom:67%;" />

将随机向量输入到decoder中，就可以使用VAE生成新的图像：

<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20221003135826242.png" alt="image-20221003135826242" style="zoom: 67%;" />
...
![image-20221002203029860](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20221002203029860.png)
...
`fopen`函数官方文档：[fopen - MathWorks](https://ww2.mathworks.cn/help/matlab/ref/fopen.html).
{: .notice--primary}
...
`fread`函数官方文档：[fread - MathWorks](https://ww2.mathworks.cn/help/matlab/ref/fread.html)。
{: .notice--primary}
...
![image-20221003110820759](https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20221003110820759.png)
...
<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20221003134757506.png" alt="image-20221003134757506" style="zoom:67%;" />
...
<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20221003134905709.png" alt="image-20221003134905709" style="zoom:67%;" />
...
<img src="https://blogimages-1309804558.cos.ap-nanjing.myqcloud.com/imgpersonal/image-20221003134942686.png" alt="image-20221003134942686" style="zoom: 67%;" />
