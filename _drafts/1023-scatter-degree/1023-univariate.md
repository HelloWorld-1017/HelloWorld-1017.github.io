...
但其实，对于偏度系数和峰度系数的计算，可以从分布函数推广到任意一个序列。MATLAB就提供了计算偏度的函数：[skewness - MathWorks](https://ww2.mathworks.cn/help/stats/skewness.html)，以及用于计算峰度的函数：[kurtosis - MathWorks](https://ww2.mathworks.cn/help/stats/kurtosis.html)，下面将分别介绍。
...
$$
E(X)=m_1,\ E(Y)=m_2,\ \mathrm{Var}(X)=\sigma_1^2,\ \mathrm{Y}=\sigma_2^2\notag
$$
