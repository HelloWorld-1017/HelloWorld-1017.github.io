...
`concatenationLayer`层是MATLAB提供的一个层，详见官方文档[concatenationLayer - MathWorks](https://ww2.mathworks.cn/help/deeplearning/ref/nnet.cnn.layer.concatenationlayer.html)，该层的作用就是连接两个网络结构：
