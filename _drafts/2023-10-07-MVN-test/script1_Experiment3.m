...
ylabel("p-value")
legend("Location","southeast")
title(sprintf("Test for kutosis (the number of repeated experiment: %s)",num2str(numEpoch)))
exportgraphics(gcf,sprintf("results-%s.png",num2str(numEpoch(end))),"Resolution",600)
