...
1. 当某一特定参数值$(\theta_1^0,\cdots,\theta_k^0)$使$H_0$成立时，我们希望$\beta_\Phi(\theta_1^0,\cdots,\theta_k^0)$尽可能小，即当$H_0$成立时，我们不希望否定它；反之，若$(\theta_1^0,\cdots,\theta_k^0)$属于对立假设，我们希望$\beta_\Phi(\theta_1^0,\cdots,\theta_k^0)$尽可能大，即当$H_0$不成立时，我们希望否定它；
...
可能范哪一种错误，要视总体分布中有关的参数值而定。比如在例1中，若参数$\lambda=0.0001$，我们只可能犯第一种错误；如果参数$\lambda=0.001$，则只可能犯第二类错误。
